...
<!--                             </div> -->
                ...
                <ol class="breadcrumb hidden-xs">
                    <li><a href="#">主页</a></li>
                    <li class="active">当前系统所有管理员</li></a>
                </ol>
                ...
                <div class="block-area" id="responsiveTable">
                    ...
                    <h2 class="block-title">当前系统所有管理员</h2>
                        ...
                        <ul class="list-inline list-mass-actions pull-left">
                            ...
                            <li>
                                <a href="" title="刷新" class="tooltips">
                                    <i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i><!--刷新-->
                                </a>
                            </li>
							
                            <li>
                                <a href="" title="删除管理员" class="tooltips">
					...
					<script>
						$(document).ready(function(){
							...
							function(data){
								...
								var str="";
								$.each(json,function(){
									str+= '<tr><td width=5px><input type="checkbox" class="pull-left list-check" value=""></td><td>'    
									+json[i].realname+'</td><td>'
									+json[i].username+'</td><td>'
									+json[i].grant+'</td><td>'
									+json[i].tel+'</td><td>'
									+json[i].email+'</td><td>'
									+json[i].qiandao+'</td></tr>';
									i++;
								});
								$("#tbody1").html(str);
							}
